<?php $__env->startSection('title', 'Daftar Orders'); ?>
<?php $__env->startSection('header_title', 'Manajemen Orders'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <div class="px-6 py-5 border-b border-gray-100 flex flex-col sm:flex-row justify-between items-center gap-4 bg-gray-50 rounded-t-xl">
            ...
            <a href="<?php echo e(route('orders.create')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg flex items-center gap-2 transition">
                ...
                <tbody class="divide-y divide-gray-100 text-sm text-gray-600 bg-white">
                    ...
                    <tr class="hover:bg-blue-50 transition duration-150">
                        <td class="px-6 py-4 font-medium text-blue-600">
                            #<?php echo e(str_pad($order->id_order, 4, '0', STR_PAD_LEFT)); ?>

                        </td>

                        <td class="px-6 py-4 font-semibold text-gray-700">
                            <div class="flex flex-col">
                                <span><?php echo e($order->user->name ?? 'User Dihapus'); ?></span>
                                <span class="text-xs text-gray-400"><?php echo e($order->user->phone ?? '-'); ?></span>
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-4">
                            ...
                            ?>
                            <span class="px-3 py-1 rounded-full text-xs font-bold uppercase <?php echo e($progressColor); ?>">
                        ...
                        <td class="px-6 py-4">
                            <?php if($order->status_payment == 'paid'): ?>
                        ...
                        <td class="px-6 py-4 text-center">
                            <div class="flex items-center justify-center gap-2">
                                <a href="<?php echo e(route('orders.show', $order->id_order)); ?>" class="p-2 bg-gray-100 rounded hover:bg-gray-200 text-gray-600 transition" title="Detail">
                                    <i data-lucide="eye" class="w-4 h-4"></i>
                                </a>

                                <form action="<?php echo e(route('orders.destroy', $order->id_order)); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus order ini?');">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\Raffi\www\Sistem-Laundry-Kel-5-FPW\laundry-app-kangcuci\resources\views/orders/index.blade.php ENDPATH**/ ?>